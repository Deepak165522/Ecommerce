    ...
    return (
        <div key={index}>
            ...
            <div className="flex flex-col gap-1 bg-gray-700 p-3 rounded-lg shadow-lg mb-6 mt-28 mx-3.5 overflow-hidden">
                ...
                <div className="flex flex-col gap-0">
                    <a href="https://www.linkedin.com/in/deepak-kumar-9337642bb" target="_blank" rel="noreferrer" className="font-medium text-lg hover:text-blue-500">Deepak Kumar</a>
                    <a href="mailto:deepakkumar165522@gmail.com" className="text-gray-300 text-sm hover:text-blue-500">deepakkumar165522@gmail.com</a>
                </div>
            </div>
        </aside>
    )
